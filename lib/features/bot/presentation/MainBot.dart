...
import 'package:code/features/bot/presentation/screens/UpdateBotDiaLog.dart';
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: BotCard(
                            ...
                            onDelete: () async {
                              final success =
                                  await botProvider.deleteBot(bot.id);
                              if (success) {
                                botProvider.clearListBot();
                                botProvider.loadBots('');
                              }
                            },
                            onTap: () {
                              Navigator.push(
